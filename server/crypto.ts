...
export class ECKeyPair {
  ...
  // We will no longer store rawPrivateKeyBytes as a separate property.
  // We will derive it directly when needed from this.privateKey.
  ...
  async init(): Promise<void> {
    ...
    // No need to store rawPrivateKeyBytes here, it will be derived in decrypt
  }
  ...
  async decrypt(encryptedPayload: string): Promise<string> {
    if (!this.privateKey) { // Only check for privateKey, raw bytes derived on demand
